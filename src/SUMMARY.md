...
- [Rust Code for Examples](building-a-comprehensive-app/rust-code/README.md)
  - [Example 1: Get Node Information](building-a-comprehensive-app/rust-code/example-1.md)
  - [Example 2: Generate Mnemonics](building-a-comprehensive-app/rust-code/example-2.md)
  - [Example 3: Create Wallet Account](building-a-comprehensive-app/rust-code/example-3/README.md)
    - [Libsodium library for Android](building-a-comprehensive-app/rust-code/example-3/libsodium.md)
  - [Example 4: Generate Address](building-a-comprehensive-app/rust-code/example-4.md)
  - [Example 5: Request Funds](building-a-comprehensive-app/rust-code/example-5.md)
  - [Example 6: Check Balance](building-a-comprehensive-app/rust-code/example-6.md)
  - [Example 7: Create DID](building-a-comprehensive-app/rust-code/example-7.md)
  - [Bin to Hex](building-a-comprehensive-app/rust-code/bin-to-hex.md)
