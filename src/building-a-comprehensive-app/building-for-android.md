...
<figure style="margin:0;border: 1px solid green;"><img src="../assets/playground/android-error-loading-dynamic-lib-failed.png" alt="Error message: Failed to load dynamic library 'librust.so'"><figcaption style="font-size: 0.8em;text-align:center;"><p style="margin: 4px 0 7px 0;">Error message: "Failed to load dynamic library 'librust.so'"</p></figcaption></figure>
...
<figure style="margin:0;border: 1px solid green;"><img src="../assets/playground/libcplusplus_copy.png" alt="Location to copy libc++_shared.so from"><figcaption style="font-size: 0.8em;text-align:center;"><p style="margin: 4px 0 7px 0;">Location to copy libc++_shared.so from</p></figcaption></figure>
...
<figure style="margin:0;border: 1px solid green;"><img src="../assets/playground/libcplusplus_paste.png" alt="Location to paste libc++_shared.so"><figcaption style="font-size: 0.8em;text-align:center;"><p style="margin: 4px 0 7px 0;">Location to paste libc++_shared.so</p></figcaption></figure>
